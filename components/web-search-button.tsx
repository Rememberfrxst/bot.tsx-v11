...
function PureWebSearchButton({ onClick, onWebSearch, isGenerating, status }: WebSearchButtonProps) {
  ...
  return (
    <Button
      ...
      className="flex items-center gap-1 rounded-full border px-1.5 py-1.5 h-fit dark:border-zinc-700 hover:dark:bg-[#272727] hover:bg-zinc-200 disabled:opacity-50 text-sm"
      onClick={handleClick}
